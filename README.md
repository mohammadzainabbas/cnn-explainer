...
[![build](https://github.com/mohammadzainabbas/cnn-explainer/workflows/build/badge.svg)](https://github.com/mohammadzainabbas/cnn-explainer/actions)
...
```bash
git clone git@github.com:mohammadzainabbas/cnn-explainer.git

# use degit if you don't want to download commit histories
degit mohammadzainabbas/cnn-explainer
```
...
The software is available under the [MIT License](https://github.com/mohammadzainabbas/cnn-explainer/blob/main/LICENSE).

## Contact

If you have any questions, feel free to [open an issue](https://github.com/mohammadzainabbas/cnn-explainer/issues/new/choose) or contact [Mohammad Zain Abbas](mohammadzainabbas@gmail.com).
